...
if __name__ == '__main__':
    ...
    test("x^3-1=0", "x=1; x=-0.5-0.8660254037844386i; x=-0.5+0.8660254037844386i", calc12)
    test("x^3=0", "x=0", calc12)
    test("x^3-3*x^2+3*x-1=0", "x=1", calc12)
    test("x^3+x^2-x-1=0", "x=-1; x=1", calc12)
    test("x^3=8", "x=2; x=-1-1.7320508075688772i; x=-1+1.7320508075688772i", calc12)
    test("x^3+1=0", "x=-1; x=0.49999999999999983-0.8660254037844387i; x=0.5000000000000001+0.8660254037844386i", calc12)
